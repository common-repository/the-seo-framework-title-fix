...
= Note: Deprecated Plugin =

> This project has been moved into [The SEO Framework - Extension Manager](https://wordpress.org/plugins/the-seo-framework-extension-manager/).
...
* Improved: Title detection no longer requires server UTF-8 support detection.
* Note: This plugin's versioning isn't in line with the extension on [The SEO Framework - Extension Manager](https://wordpress.org/plugins/the-seo-framework-extension-manager/).
